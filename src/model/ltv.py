...
class PortfolioState:
    ...
    bvusd_outstanding: float   # bvUSD loan amount outstanding
    ...
    def current_ltv(self) -> float:
        ...
        if self.collateral_value == 0:
            return float('inf')
        return self.bvusd_outstanding / self.collateral_value
...
class LTVRiskMetrics:
    ...
    drop_to_margin_call: float  # Percentage drop required
    ...
    def __str__(self) -> str:
        return (
            ...
            f"    Required drop: {self.drop_to_margin_call:.1f}%\n"
            ...
            f"    Required drop: {self.drop_to_liquidation:.1f}%\n"
...
class LTVRiskCalculator:
    ...
    def calculate_risk(
        ...
        drop_to_mc = (1 - margin_call_price / portfolio.btc_price) * 100
        drop_to_liq = (1 - liquidation_price / portfolio.btc_price) * 100
...
def analyze_portfolio(
    ...
    Args:
        ...
        bvusd_outstanding: bvUSD loan amount
    ...
    portfolio = PortfolioState(
        ...
        bvusd_outstanding=bvusd_outstanding,
        btc_price=btc_price
    )
...
if __name__ == "__main__":
    ...
    btc_collateral = 10.0  # 10 BTC
    bvusd_outstanding = 500_000  # $500k loan
    regime = "normal"
    ...
    for arg in sys.argv[1:]:
        if arg.startswith("--btc="):
            ...
            bvusd_outstanding = float(arg.split("=")[1])
        elif arg == "--stress":
            regime = "stress"
